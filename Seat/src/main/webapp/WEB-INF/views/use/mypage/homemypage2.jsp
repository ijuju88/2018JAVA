...
<body>
	...
	<form:form action="homememberupdate.do" method="post" modelAttribute="smVO"
		autocomplete="off">
		<!-- 아이디 -->
		...
		<div class="form-group row mb-4">
			...
			<div class="col-sm-10">
				<input type="email" class="form-control" id="m_email" name="m_email"
					placeholder="Email" value="${smVO.m_email}"/>
			</div>
			<div class="col-sm-10">
		...
		<div class="form-group row mb-4">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="m_addr1" name="m_addr1"
					placeholder="간략주소" readonly  value="${smVO.m_addr1}"/>
			</div>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="m_addr2" name="m_addr2"
					placeholder="상세주소"value="${smVO.m_addr2}" />
			</div>
			<div class="col-sm-10">
