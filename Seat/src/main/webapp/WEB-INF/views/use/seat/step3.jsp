	...
	<div id="tabs-3">
								...
								<table class="table table-sm table-primary">
									...
									<tbody>
										...
										<c:forTokens items="${seat3map.SSR_SEAT}" delims=","
											var="item">
											<c:if test="${fn:contains(item,'A')|| fn:contains(item,'B')}">
												<tr>
													<td>VIP석 : ${item}</td>
													<td>${ssplVO.show_vipprice}원</td>
												</tr>
											</c:if>

											<c:if
												test="${fn:contains(item,'C')|| fn:contains(item,'D')
											|| fn:contains(item,'E')}">
												<tr>
													<td>R석 : ${item}</td>
													<td>${ssplVO.show_rprice}원</td>
												</tr>
											</c:if>

											<c:if
												test="${fn:contains(item,'F')|| fn:contains(item,'G')
												|| fn:contains(item,'H')}">
												<tr>
													<td>S석 : ${item}</td>
													<td>${ssplVO.show_sprice}원</td>
												</tr>
											</c:if>

											<c:if
												test="${fn:contains(item,'I')|| fn:contains(item,'J')
												|| fn:contains(item,'K')|| fn:contains(item,'L')}">
												<tr>
													<td>A석 : ${item}</td>
													<td>${ssplVO.show_aprice}원</td>
												</tr>
											</c:if>
										</c:forTokens>
										<tr>
		...
		<ul class="list-inline">
			...
			<c:choose>
				...
				<li><button type="button" class="btn btn-primary chk">예약하기</button></li>
				</c:when>
