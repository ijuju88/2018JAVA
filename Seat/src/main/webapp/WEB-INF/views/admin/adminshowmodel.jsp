	...
	<div id="my_form">
		...
		<form action="adminshowseatedit.do" id="realForm" method="POST"
			...
			<div class="form-group row">
				<label for="show_no" class="col-sm-2 col-form-label labels">공연번호</label>
				<div class="col-sm-10">
					<input type="text" readonly class="form-control" id="show_no"
						name="show_no">
				</div>
			</div>
			...
			<div class="row">
				<label for="start_date" class="col-sm-2 col-form-label labels">시작시간</label>
				<div class='col-sm-6'>
			...
			<div class="row">
				<label for="end_date" class="col-sm-2 col-form-label labels">마치는시간</label>
				<div class='col-sm-6'>
